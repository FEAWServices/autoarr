...
class TestOrchestratorConnectionManagement:
    ...
    @pytest.mark.asyncio
    async def test_connect_all_connects_to_all_enabled_servers(
    ...
    async def test_connect_all_skips_disabled_servers(
        self, mcp_orchestrator_config_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_connect_all_retries_failed_connections(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_connect_all_respects_max_retries(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_disconnect_all_closes_all_connections(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_disconnect_all_handles_disconnect_errors(
        self, orchestrator, mock_clients
    ):
        """Test that disconnect_all handles errors gracefully."""
        # Arrange
        mock_clients["sonarr"].disconnect = AsyncMock(
    ...
    @pytest.mark.asyncio
    async def test_is_connected_returns_connection_status(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_is_connected_returns_false_for_disconnected_server(
        self, orchestrator
    ):
    ...
    @pytest.mark.asyncio
    async def test_connection_pooling_reuses_connections(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_connection_attempts_are_safe(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_connection_state_persistence_across_restarts(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_connection_keepalive_mechanism(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_auto_reconnect_on_connection_loss(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_graceful_shutdown_waits_for_pending_requests(
        self, orchestrator, mock_clients
    ):
...
class TestOrchestratorToolRouting:
    ...
    async def test_call_tool_routes_to_correct_server(
        ...
        with patch.object(orchestrator, "_create_client") as mock_create:
            ...
            # Assert
            mock_clients["sabnzbd"].call_tool.assert_called_once_with(
                "get_queue", {}
            )
    ...
    @pytest.mark.asyncio
    async def test_call_tool_validates_server_is_connected(
        self, orchestrator
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_validates_tool_name(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_validates_params_type(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_passes_params_correctly(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_returns_result_data(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_handles_tool_not_found_error(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_handles_tool_execution_error(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_respects_timeout_parameter(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_list_available_tools_for_server(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_list_all_tools_across_all_servers(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_tool_routing_with_alias_names(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_tool_includes_metadata_in_result(
        self, orchestrator, mock_clients
    ):
...
class TestOrchestratorParallelExecution:
    ...
    @pytest.mark.asyncio
    async def test_call_tools_parallel_empty_list_returns_empty_results(
        self, orchestrator
    ):
    ...
    async def test_call_tools_parallel_provides_progress_callback(
        ...
        with patch.object(orchestrator, "_create_client") as mock_create:
            ...
            # Act
            await orchestrator.call_tools_parallel(
...
class TestOrchestratorErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_closes_after_successful_calls(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_timeout_errors_are_handled_gracefully(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_connection_error_triggers_reconnection_attempt(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_callback_is_invoked_on_failures(
        self, orchestrator, mock_clients
    ):
...
class TestOrchestratorHealthChecks:
    ...
    @pytest.mark.asyncio
    async def test_health_check_single_server(
        self, orchestrator, mock_clients
    ):
    ...
    async def test_health_check_handles_connection_error(
        ...
        # Arrange
        mock_clients["sonarr"].health_check = AsyncMock(
    ...
    @pytest.mark.asyncio
    async def test_health_check_retries_on_transient_failure(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_health_check_marks_server_down_after_failures(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_periodic_health_checks_run_automatically(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_health_check_includes_detailed_diagnostics(
        self, orchestrator, mock_clients
    ):
...
class TestOrchestratorResourceManagement:
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_cleans_up_on_shutdown(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_context_manager_support(
        self, orchestrator_config, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_handles_cleanup_errors(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_resource_leak_detection(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_restart_orchestrator_preserves_configuration(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_memory_usage_stays_bounded(
        self, orchestrator, mock_clients
    ):
    ...
    @pytest.mark.asyncio
    async def test_proper_task_cleanup_on_cancellation(
        self, orchestrator, mock_clients
    ):
        ...
        with patch.object(orchestrator, "_create_client") as mock_create:
            ...
            task = asyncio.create_task(
                orchestrator.call_tool("plex", "scan_library", {})
            )
            await asyncio.sleep(0.1)
            task.cancel()
    ...
    @pytest.mark.asyncio
    async def test_connection_pool_releases_on_error(
        self, orchestrator, mock_clients
    ):
