...
class TestSABnzbdMCPServerInitialization:
    ...
    @pytest.mark.asyncio
    async def test_server_validates_connection_on_startup(
        self, mock_sabnzbd_client
    ) -> None:
...
class TestSABnzbdMCPServerRetryDownloadTool:
    ...
    @pytest.mark.asyncio
    async def test_retry_download_calls_client_retry(
        self, mcp_server, mock_sabnzbd_client
    ) -> None:
...
class TestSABnzbdMCPServerSetConfigTool:
    ...
    @pytest.mark.asyncio
    async def test_set_config_returns_success_status(
        self, mcp_server, mock_sabnzbd_client
    ) -> None:
...
class TestSABnzbdMCPServerErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handles_client_error_gracefully(
        self, mcp_server, mock_sabnzbd_client
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_error_responses_include_details(
        self, mcp_server, mock_sabnzbd_client
    ) -> None:
