...
class TestHealthEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_overall_health_check_degraded(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_overall_health_check_unhealthy(self, client):
    ...
    @pytest.mark.asyncio
    async def test_service_health_check_not_connected(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_status(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_health_check_unhealthy_service(self, client, mock_orchestrator):
