...
class TestDownloadsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_download_queue(self, client, mock_orchestrator):
        ...
        with patch("api.dependencies.get_orchestrator") as mock_get_orch:
            ...
            mock_get_orch.return_value = mock_generator()
    ...
    @pytest.mark.asyncio
    async def test_retry_download(self, client, mock_orchestrator):
...
class TestShowsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_shows(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_search_shows(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_add_show(self, client, mock_orchestrator):
...
class TestMoviesEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_movies(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_search_movies(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_add_movie(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_delete_movie(self, client, mock_orchestrator):
...
class TestMediaEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_libraries(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_get_recently_added(self, client, mock_orchestrator):
        """Test getting recently added media."""
        mock_orchestrator.call_tool.return_value = [
            {"rating_key": "123", "title": "The Matrix"}
        ]
    ...
    @pytest.mark.asyncio
    async def test_scan_library(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_search_media(self, client, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_get_sessions(self, client, mock_orchestrator):
