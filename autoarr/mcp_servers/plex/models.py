...
class PlexLibrary(BaseModel):
    ...
    content_changed_at: Optional[int] = Field(
        None, alias="contentChangedAt", description="Content change timestamp"
    )
...
class PlexMediaItem(BaseModel):
    ...
    audience_rating: Optional[float] = Field(
        None, alias="audienceRating", description="Audience rating"
    )
    ...
    originally_available_at: Optional[str] = Field(
        None, alias="originallyAvailableAt", description="Original air date"
    )
    added_at: int = Field(..., alias="addedAt", description="Date added timestamp")
    updated_at: int = Field(..., alias="updatedAt", description="Last update timestamp")
    audience_rating_image: Optional[str] = Field(
        None, alias="audienceRatingImage", description="Audience rating image"
    )
    primary_extra_key: Optional[str] = Field(
        None, alias="primaryExtraKey", description="Primary extra key"
    )
    ...
    last_viewed_at: Optional[int] = Field(
        None, alias="lastViewedAt", description="Last viewed timestamp"
    )

    # TV Show specific fields
    parent_rating_key: Optional[str] = Field(
        None, alias="parentRatingKey", description="Parent rating key (for episodes)"
    )
    grandparent_rating_key: Optional[str] = Field(
        None, alias="grandparentRatingKey", description="Grandparent rating key (for episodes)"
    )
    parent_title: Optional[str] = Field(
        None, alias="parentTitle", description="Parent title (season)"
    )
    grandparent_title: Optional[str] = Field(
        None, alias="grandparentTitle", description="Grandparent title (show)"
    )
    ...
    media: Optional[List[Dict[str, Any]]] = Field(
        None, alias="Media", description="Media information"
    )
    genre: Optional[List[Dict[str, Any]]] = Field(None, alias="Genre", description="Genres")
    director: Optional[List[Dict[str, Any]]] = Field(
        None, alias="Director", description="Directors"
    )
...
class PlexSession(BaseModel):
    ...
    view_offset: int = Field(
        0, alias="viewOffset", description="Current playback position in milliseconds"
    )
...
class PlexServerIdentity(BaseModel):
    ...
    my_plex_username: Optional[str] = Field(
        None, alias="myPlexUsername", description="Plex.tv username"
    )
    my_plex_mapping_state: Optional[str] = Field(
        None, alias="myPlexMappingState", description="Plex.tv mapping state"
    )
    my_plex_signin_state: Optional[str] = Field(
        None, alias="myPlexSigninState", description="Plex.tv signin state"
    )
    ...
    friendly_name: Optional[str] = Field(
        None, alias="friendlyName", description="Friendly server name"
    )
    size: Optional[int] = Field(None, alias="size", description="Directory size")
    allow_camera_upload: Optional[bool] = Field(
        None, alias="allowCameraUpload", description="Allow camera upload"
    )
    allow_channel_access: Optional[bool] = Field(
        None, alias="allowChannelAccess", description="Allow channel access"
    )
    allow_media_deletion: Optional[bool] = Field(
        None, alias="allowMediaDeletion", description="Allow media deletion"
    )
    ...
    background_processing: Optional[bool] = Field(
        None, alias="backgroundProcessing", description="Background processing enabled"
    )
    certificate: Optional[bool] = Field(None, alias="certificate", description="Has certificate")
    companion_proxy: Optional[bool] = Field(
        None, alias="companionProxy", description="Companion proxy enabled"
    )
    diagnostics: Optional[str] = Field(None, alias="diagnostics", description="Diagnostics")
    event_stream: Optional[bool] = Field(
        None, alias="eventStream", description="Event stream enabled"
    )
    hub_search: Optional[bool] = Field(None, alias="hubSearch", description="Hub search enabled")
    item_clusters: Optional[bool] = Field(
        None, alias="itemClusters", description="Item clusters enabled"
    )
    multiuser: Optional[bool] = Field(None, alias="multiuser", description="Multiuser enabled")
    photo_auto_tag: Optional[bool] = Field(
        None, alias="photoAutoTag", description="Photo auto-tagging enabled"
    )
    ...
    push_notifications: Optional[bool] = Field(
        None, alias="pushNotifications", description="Push notifications enabled"
    )
    read_only_libraries: Optional[bool] = Field(
        None, alias="readOnlyLibraries", description="Read-only libraries enabled"
    )
    streaming_brain_abr_version: Optional[int] = Field(
        None, alias="streamingBrainABRVersion", description="Streaming brain ABR version"
    )
    streaming_brain_version: Optional[int] = Field(
        None, alias="streamingBrainVersion", description="Streaming brain version"
    )
    sync: Optional[bool] = Field(None, alias="sync", description="Sync enabled")
    transcoder_active_video_sessions: Optional[int] = Field(
        None, alias="transcoderActiveVideoSessions", description="Active transcode sessions"
    )
    transcoder_audio: Optional[bool] = Field(
        None, alias="transcoderAudio", description="Audio transcoding available"
    )
    transcoder_lyrics: Optional[bool] = Field(
        None, alias="transcoderLyrics", description="Lyrics transcoding available"
    )
    transcoder_photo: Optional[bool] = Field(
        None, alias="transcoderPhoto", description="Photo transcoding available"
    )
    transcoder_subtitles: Optional[bool] = Field(
        None, alias="transcoderSubtitles", description="Subtitle transcoding available"
    )
    transcoder_video: Optional[bool] = Field(
        None, alias="transcoderVideo", description="Video transcoding available"
    )
    transcoder_video_bitrates: Optional[str] = Field(
        None, alias="transcoderVideoBitrates", description="Video transcoding bitrates"
    )
    transcoder_video_qualities: Optional[str] = Field(
        None, alias="transcoderVideoQualities", description="Video transcoding qualities"
    )
    transcoder_video_resolutions: Optional[str] = Field(
        None, alias="transcoderVideoResolutions", description="Video transcoding resolutions"
    )
    ...
    voice_search: Optional[bool] = Field(
...
class PlexHistoryRecord(BaseModel):
    ...
    grandparent_thumb: Optional[str] = Field(
        None, alias="grandparentThumb", description="Grandparent thumbnail"
    )
    grandparent_title: Optional[str] = Field(
        None, alias="grandparentTitle", description="Show title"
    )
