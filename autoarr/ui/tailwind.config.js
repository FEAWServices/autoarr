  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(250, 70%, 50%, 0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(260, 80%, 60%, 0.3) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(240, 60%, 40%, 0.3) 0px, transparent 50%)',
      },
      backdropBlur: {
        xs: '2px',
      },
