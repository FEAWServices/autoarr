    ...
    try:
        ...
        if libraries:
            ...
            for lib in libraries:
                print_info(f"  - {lib.get('title', 'Unknown')} (Type: {lib.get('type', 'Unknown')}, Key: {lib.get('key', 'N/A')})")
            return True
        else:
    ...
    try:
        ...
        if items:
            ...
            for item in items[:3]:  # Show first 3
                print_info(f"  - {item.get('title', 'Unknown')} (Type: {item.get('type', 'Unknown')})")
            return True
        else:
    ...
    try:
        ...
        if results:
            ...
            for result in results[:3]:  # Show first 3
                print_info(f"  - {result.get('title', 'Unknown')} (Type: {result.get('type', 'Unknown')})")
            return True
        else:
