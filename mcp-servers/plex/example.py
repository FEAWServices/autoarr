    ...
    try:
        ...
        if sessions:
            ...
            for i, session in enumerate(sessions, 1):
                ...
                print(f"  Player: {player.get('product', 'Unknown')} on {player.get('platform', 'Unknown')}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default=os.getenv("PLEX_URL", "http://localhost:32400"),
