...
class Episode(BaseModel):
    ...
    absolute_episode_number: Optional[int] = Field(None, alias="absoluteEpisodeNumber", description="Absolute episode number")
...
class WantedMissing(BaseModel):
    ...
    sort_direction: Optional[str] = Field(None, alias="sortDirection", description="Sort direction")
    total_records: int = Field(..., alias="totalRecords", description="Total number of records")
    records: List[Dict[str, Any]] = Field(default_factory=list, description="Missing episode records")
