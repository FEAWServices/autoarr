...
class Movie(BaseModel):
    ...
    in_cinemas: Optional[str] = Field(None, alias="inCinemas", description="Date movie was released in cinemas")
    physical_release: Optional[str] = Field(None, alias="physicalRelease", description="Physical release date")
    digital_release: Optional[str] = Field(None, alias="digitalRelease", description="Digital release date")
    ...
    root_folder_path: Optional[str] = Field(None, alias="rootFolderPath", description="Root folder path")
    ...
    youtube_trailer_id: Optional[str] = Field(None, alias="youTubeTrailerId", description="YouTube trailer ID")
    studio: Optional[str] = Field(None, description="Movie studio")
    minimum_availability: Optional[str] = Field(None, alias="minimumAvailability", description="Minimum availability")
    folder_name: Optional[str] = Field(None, alias="folderName", description="Folder name")
    clean_title: Optional[str] = Field(None, alias="cleanTitle", description="Clean title for search")
    size_on_disk: Optional[int] = Field(None, alias="sizeOnDisk", description="Size on disk in bytes")
    movie_file: Optional[Dict[str, Any]] = Field(None, alias="movieFile", description="Movie file information")
...
class MovieFile(BaseModel):
    ...
    media_info: Optional[Dict[str, Any]] = Field(None, alias="mediaInfo", description="Media information")
...
class QueueRecord(BaseModel):
    ...
    estimated_completion_time: Optional[str] = Field(None, alias="estimatedCompletionTime", description="ETA")
    status: str = Field(..., description="Download status")
    tracked_download_status: Optional[str] = Field(None, alias="trackedDownloadStatus", description="Tracked status")
    tracked_download_state: Optional[str] = Field(None, alias="trackedDownloadState", description="Tracked state")
    ...
    download_client: Optional[str] = Field(None, alias="downloadClient", description="Download client name")
