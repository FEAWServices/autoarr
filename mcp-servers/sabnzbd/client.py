...
class SABnzbdClient:
    ...
    async def _request(
        self, mode: str, max_retries: int = 3, **params: Any
    ) -> Dict[str, Any]:
        """
        ...
        if last_error:
            raise SABnzbdConnectionError(f"Connection failed after {max_retries} attempts: {last_error}")
    ...
    async def delete_download(
        self, nzo_id: str, delete_files: bool = False
    ) -> Dict[str, Any]:
        """
